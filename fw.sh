...
# Bittorrent 
$IPT -A tcp_inbound -p TCP -s 0/0 --destination-port 6881:6889 -j ACCEPT
$IPT -A tcp_inbound -p TCP -s 0/0 --destination-port 25808 -j ACCEPT
$IPT -A tcp_inbound -p UDP -s 0/0 --destination-port 25808 -j ACCEPT
